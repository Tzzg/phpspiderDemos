...
//    'log_show' => true,
    ...
    'scan_urls' => array(
        'http://corp.efu.com.cn/list-1-0-0-0-0-0-1.html'
    ),
...
//        "/search/factory-c-0-k--p\d+",<a href="/factory/index/page/2.html">2</a>
        "http://corp.efu.com.cn/list-\d+-0-0-0-0-0-\d+.html"
    ),
    'content_url_regexes' => array(///factory/index/page/<a href="/store/4015/index.html" class="title" target="_blank" title="邓洋（个体经营）">邓洋（个体经营）</a>
        "http://corp.efu.com.cn/corpindex-\d+.html",
    ),
    'max_try' => 5,
    //'proxies' => array(
...
//    ),
    ...
    'fields' => array(
       array(//
            'name' => "name",///html/body/div[3]/div[1]/div[1]/div/div[2]/h1
            'selector' => "/html/body/div[2]/div[1]/div[1]/div/div[2]/h1",
            'required' => true,
        ),
        array(
            'name' => "type",
            'selector' => "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[4]/dl[4]/dd/a",
            'required' => true,
        ),
        array(
            'name' => "fanwei",
            'selector' => "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[4]/dl[5]/dd",
            'required' => true,
        ),

        array(
            'name' => "area",
            'selector' => "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[4]/dl[7]/dd/a",
            'required' => true,
        ),
        array(
            'name' => "contact",
            'selector' => "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[6]/dl[1]/dd",
            'required' => true,
        ),
        array(
            'name' => "tel",
            'selector' => "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[6]/dl[3]/dd",
            'required' => true,
        ),
...
//     requests::set_cookies($cookies, 'www.dingdingdan.com');
    ...
    requests::set_header("Referer", "http://corp.efu.com.cn/list-1-9-0-0-0-0-1.html");
